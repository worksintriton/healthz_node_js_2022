...
router.post('/filter_date', function (req, res) {
        servicebannerModel.find({}, function (err, StateList) {
          var final_Date = [];
...
router.get('/deletes', function (req, res) {
      servicebannerModel.remove({}, function (err, user) {
...
router.post('/getlist_id', function (req, res) {
        servicebannerModel.find({Person_id:req.body.Person_id}, function (err, StateList) {
...
router.get('/getlist', function (req, res) {
        servicebannerModel.find({}, function (err, Functiondetails) {
...
router.get('/mobile/getlist', function (req, res) {
        servicebannerModel.find({show_status:true}, function (err, Functiondetails) {
          let a = {
...
servicebannerModel.findByIdAndRemove(req.body._id, function (err, user) {
          if (err) return res.json({Status:"Failed",Message:"Internal Server Error", Data : {},Code:500});

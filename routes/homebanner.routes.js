...
router.post('/filter_date', function (req, res) {
        homebannerModel.find({}, function (err, StateList) {
          var final_Date = [];
...
router.get('/deletes', function (req, res) {
      homebannerModel.remove({}, function (err, user) {
...
router.post('/getlist_id', function (req, res) {
        homebannerModel.find({Person_id:req.body.Person_id}, function (err, StateList) {
...
router.get('/getlist', function (req, res) {
        homebannerModel.find({}, function (err, Functiondetails) {
...
router.get('/mobile/getlist', function (req, res) {
        homebannerModel.find({show_status:true}, function (err, Functiondetails) {
          let a = {
...
router.post('/edit', function (req, res) {
        homebannerModel.findByIdAndUpdate(req.body._id, req.body, {new: true}, function (err, UpdatedDetails) {
...
homebannerModel.findByIdAndRemove(req.body._id, function (err, user) {
          if (err) return res.json({Status:"Failed",Message:"Internal Server Error", Data : {},Code:500});
